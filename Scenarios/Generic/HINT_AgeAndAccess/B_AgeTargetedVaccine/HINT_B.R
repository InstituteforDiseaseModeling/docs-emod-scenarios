...
setwd(file.path(PROJECT_ROOT, 'Scenarios', 'Generic', 'HINT_AgeAndAccess', 'B_AgeTargetedVaccine'))
...
## this not 0)
config_temp$parameters$Incubation_Period_Constant <- 5
...
## We can alter the ages that recieve the intervention
