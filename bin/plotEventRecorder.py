...
def main(filename, logplot):
    ...
    figure = pyplot.figure(filename, figsize=(10,7))
    ...
    pyplot.subplots_adjust(top=0.5, bottom=0.15) # Make space for the titles
    ...
    for event in sorted(events):
        ...
        for group in range(plot_rows):
            ...
            if group == 0:
                pyplot.title(event, rotation=90, verticalalignment='bottom', fontsize=10)
